      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // find ref_v to use
            // by checking the other cars on the same lane
            ...
            for (int i=0; i < sensor_fusion.size(); i++) {
                ...
                /*if (d < (2+4*lane+2) && d > (2+4*lane-2) )  {
                    ...
                    if ((check_car_s > car_s) && (check_car_s-car_s) < 30) {
                        ...
                        // try to use a fixed, slower speed first
                        //ref_vel = 29.5; //mph
                        too_close = true;
                        if (lane > 0) {
                            lane = 0;
            ...
            if ( car_ahead ) { // Car ahead
                if ( !car_left && lane > 0 ) {
                    // if there is no car left and ego-vehilce is not at the left most lane
            ...
            // use the previous path's end point as starting reference
                ...
                // use two points that make the path tangent to the pprevious path's end point
            ...
            for(int i = 0; i < 50; i++)
            {
                double next_s = car_s + ((i+1)*dist_inc); // transitioning
                double next_d = 6;
